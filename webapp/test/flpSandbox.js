		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title for project6",
									"targetURL": "#project6project6-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project6project6-display": {
								"semanticObject": "project6project6",
								"action": "display",
								"description": "A Fiori application for project6",
								"title": "App Title for project6",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project6.project6",
									"url": sap.ui.require.toUrl("project6/project6")
								}
							}
						}
					}
